...
export const metadata: Metadata = {
  ...
  description: "Need time off to care for a sick family member? Learn how to get a carer's leave certificate online. Pharmacist-issued, Fair Work compliant, $24.95.",
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="bg-[#1A1A1A] text-[#FDF8EE] rounded-2xl p-8 my-12 text-center">
              ...
              <p className="text-[#FDF8EE]/70 mb-6">
                Get a carer&apos;s leave certificate in minutes. $24.95 — only charged if issued.
              </p>
              <Link 
                href="/book/carer" 
