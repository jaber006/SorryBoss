...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://sorryboss.com.au/blog/do-i-need-medical-certificate-for-one-day",
  },
  openGraph: {
    ...
    url: "https://sorryboss.com.au/blog/do-i-need-medical-certificate-for-one-day",
  },
};
      ...
      <article className="pt-32 pb-20 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <ol>
              <li><strong>Pharmacist certificate (fastest):</strong> Services like SorryBoss offer phone consultations with AHPRA-registered pharmacists. 5 minutes, $13.99, certificate emailed instantly.</li>
