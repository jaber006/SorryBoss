...
export const metadata: Metadata = {
  title: "Sick Leave Rights in Australia: Complete Guide (2026) | SorryBoss",
      ...
      <article className="pt-32 pb-20 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <ul>
              <li><strong>Pharmacist certificate (5 mins, $24.95):</strong> Phone consult, certificate emailed</li>
            ...
            <div className="bg-[#1A1A1A] text-[#FDF8EE] rounded-2xl p-8 my-12 text-center">
              ...
              <p className="text-[#FDF8EE]/70 mb-6">
                Get one in 5 minutes. Phone consult with AHPRA pharmacist. $24.95 — only if issued.
              </p>
